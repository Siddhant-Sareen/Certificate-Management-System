...
<div class="dropdown-zone row txt">
	<div class="col-sm-6 col-xs-12">
     ...
     <select disabled class="form-control form-control-lg input " id="job-title" name="job-title" style="height: 26px; padding-top: 1px">
       ...
       <div class="col-sm-6 bg col-xs-12">
        ...
        <select disabled class="form-control form-control-lg input select" id="appointing-officer" style="height: 26px; padding-top: 1px" name="appointing-officer">
...
<div class="row txt">
	...
	<div class="col-sm-6 bg col-xs-12">
        ...
        <select disabled class="form-control form-control-lg  select txt" id="officer-designation" style="height: 26px; padding-top: 1px;" name="officer-designation">
		  <option selected='selected' hidden value="0">none</option>
			...
			<!--/down-->
                           ...
                           <div class="menu"  >
							...
							<li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Intern Certificate</span> <span class="fa fa-angle-right" style="float: right; "></span></a>
											 <ul id="menu-academico-sub" >
												<li id="menu-academico-avaliacoes" ><a href="search_agreement.php">Internship agreement</a></li>
