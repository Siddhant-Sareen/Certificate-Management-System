...
<div class="row">
        ...
        <div class="row" >
        <span class="col-6  ">
        <button type="button" class="btn btn-default" style="background-color:#88C9C9" onclick="valid();">Submit</button>
		</span>
		<span class="col-6  ">
		<button type="button" class="btn btn-default"  style="padding-right:18px; padding-left:18px; background-color:#88C9C9" onclick="a= confirm('Are you sure you want to reset the whole form?');if(a){reset();}else{};">Reset
		</button>
		</span>
		<hr style="border-style:solid;width:100%;border-width:1px;border-color:grey"></hr>
		</div>
...
<p style="color: #ffffff; font-size: 12px">(2017 All Rights Reserved)</p>
			...
			<!--/down-->
							<div class="down">	
									  ...
									  <a href="index.html"><span class=" name-caret">User Name</span></a>
									 <p>User</p>
									 <br>
									<ul>
										...
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
										 ...
										 <li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Employee Certificate</span> <span class="fa fa-angle-right" style="float: right; "></span></a>
											 <ul id="menu-academico-sub" >
												...
												<li id="menu-academico-boletim" ><a href="experience1.html">Experience Certificate</a></li>
