...
label{
  ...
  <script src='js/delete_relieving.js'></script>
...
function resize()
{
 if ($(window).width() < 800) {
    ...
    $('label').addClass('a');
    $('#candile').css('width','100%');
    $('#candile').css('margin-left','12%');
					...
					<!-- //header-ends -->
						<div class="outter-wp">
								<!--custom-widgets-->
												...
												<!--//custom-widgets-->
												<!--/candile-->
													<div class="candile" style='margin-left:-123px;' id="candile"> 
...
<br>
    ...
    <div class="col-md-6 col-xs-10 bg txt">
	 ...
	 <label for="registration_id" id="registration_id" style="color: #FFFE65; font-size: 14px;"> </label>
    </div></div>
</div>
