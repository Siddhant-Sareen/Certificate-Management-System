...
background: rgba(0, 0, 0, 0.6);
  ...
  .card{
    background-color: rgba(23,164,182,0.3);
  }
  .a{
    font-size: 18px;
  }
...
label{
  ...
  <script src="js/delete_appointing.js"></script>
   <script type="text/javascript">
    function is_selected()
   {
      $("#ab").html('<div align="right;" class="col-md-5" style="color: #ffffff;"><label  id="dynamic"  for="search" style="text-align:right;" ></label></div><div class="col-md-1"></div><div class="col-md-6"><input  type="text" name="search_option" class="form-control"  id="search_by"></div>')
      $("#ab").css("padding","20px");
    ...
    if($("#search").val()=="2")
    {
      ...
      //$("#search_by").attr("id","value_phone") ;
        ...
        $("#search_by").attr("maxlength","10");
        $("#search_by").attr("onkeydown","validity()");
...
<center>													
  ...
  <center>
<form     id="form-element" autocomplete="off" >
    ...
    <h3 style="color:#ffffff" align="left">Edit Information</h3>
     ...
     <div  class="row" style="padding-top: 3%; margin:2%;">
      <div>
       ...
       <button type="button" class="btn btn-default input"  style="padding-right:18px; padding-left:18px; background-color:#88F9F9; margin-top: 0px; " id="button1" onclick="valid_search_delete();">
     ...
     <div class="row txt">
       ...
       <label for="name"> Full Name&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
       <label id="name" style="text-transform:uppercase; color: #FFFE65" ></label>
      
     </div>
<br>
<div class="col-sm-6 bg txt">
      <label for="name"  >Address &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
      <label for="name" id="address" style="text-transform:uppercase; color: #FFFE65"></label>
  ...
  <div class="form-group "> 
    <div class="row  txt">
      <div class="col-sm-6">
         ...
         <label for="email"  > Email&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp :&nbsp&nbsp&nbsp&nbsp</label>
...
<div class="dropdown-zone row txt">
  <div class="col-sm-6">
      <label for="job-title">Job Title&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
      <label for="job-title" id="job-title" style="text-transform:uppercase; color: #FFFE65"></label>
     
      </div>
      <div class="col-sm-6 bg">
      <label for="place-of-posting" >Place of joining :&nbsp&nbsp&nbsp&nbsp</label>
      <label for="place-of-posting" id="place-of-posting" style="text-transform:uppercase;color: #FFFE65"></label>
    </div>
...
<div class="row txt">
    ...
    <div class="col-md-6 col-xs-10 bg txt">
      <label for="registration_id"  style="color: #ffffff">Registration ID&nbsp:&nbsp&nbsp&nbsp&nbsp</label>
...
<div class="row txt" >
    ...
    <span class="col-6 ">
      <button type="button" class="btn btn-default input button" style="background-color:#88F9F9;box-shadow:1px 2px 12px black;" onclick="deleted();"> &nbsp Delete &nbsp </button>
    </span>
