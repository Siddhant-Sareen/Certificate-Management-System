...
<div class="col-sm-6 bg">
  ...
  font-size:15px;" >none</option>
	...
	<div class="col-sm-6 ">
      ...
      <select class="form-control form-control-lg "  id="department-of-work" name="department-of-work" style="height:25px;padding:0%;font-size:15px;" >
	     <option value="0" style="height:25px;padding:0%;font-size:15px;font-align:left; " >none</option>
         <option value="1" style="font-size:15px;height:25px;">first</option> 
         <option  value="2"style="font-size:15px;height:25px;">second</option>
         <option value="3" style="font-size:15px;height:25px;">third</option>
      </select>
