...
.card{
  ...
  <script src='js/up_relieving.js'></script>
...
<div id="loading" style="color:white;position:fixed;display:block;width:100%;height:100%;padding-right:34%;padding-top:-200%;background:rgba(0,0,0,0.6);z-index:1366;">
...
<div class="col-sm-6 bg">
      ...
      <input type="text" class="form-control input" id="reg_id"  name="registration_id" >
    </div>
...
<footer  style="margin-left:-20%; width:140%; " class="inner-content">
