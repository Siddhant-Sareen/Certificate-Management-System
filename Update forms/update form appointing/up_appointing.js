...
data: { name: $("#name").val(),address:$("#address").val(),email: $("#email").val(),phone:$("#phone").val(), job_title:$("#job-title").val(),appointing_officer:$("#appointing-officer").val(),officer_designation:$("#officer-designation").val(),place_posting:$("#place-of-posting").val(),timeIn:$("#timefrom").val(),timeOut:$("#timeto").val(),date1:$("#date1").val(),Registeration_id:$("#Registeration_id").val(),salary:$("#salary").val(),date_printing:$("#date-of-printing").val(),certificate_category:$("#certificate_category").val()},
beforeSend: function() {
$("#loading").fadeIn();
},
...
$('#job_title').val($('#new_job_title').val());
$('#appointing_officer').val($('#new_appointing_officer').val());
$('#place_of_posting').val($('#new_place_posting').val());
$('#officer_designation').val($('#new_officer_designation').val());
...
data: {search:$("#search_by").val(), name: $("#name").val(),address:$("#address").val(),email: $("#email").val(),phone:$("#phone").val(), job_title:$("#job_title").val(),appointing_officer:$("#appointing_officer").val(),officer_designation:$("#officer_designation").val(),place_posting:$("#place_of_posting").val(),timeIn:$("#timefrom").val(),timeOut:$("#timeto").val(),date1:$("#date1").val(),Registeration_id:$("#Registeration_id").val(),salary:$("#salary").val(),date_printing:$("#date-of-printing").val()},
beforeSend: function() {
$("#loading").fadeIn();
},
success:function(response){
