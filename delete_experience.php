...
<html>
<head>
<title>Wt It Solution Pvt Ltd: Experience Delete</title>
<meta charset="utf-8">
...
color: #fff;
  ...
  <script src='js/delete_experience.js'></script>
...
<br><br>
<center>
<img src="images/loading.gif" style="height:100px; width:100px;margin-right: 30%;">
<br>
<h5>Loading...</h5>
</center>
</div>
...
<div class="col-sm-6">
      ...
      <label for="job-title" id="position-of-responsibility" style="text-transform:uppercase; color: #FFFE65"></label>
							...
							<li id="menu-academico"><a href="#"><i class="fa fa-file-text-o"></i> <span>Intern Certificate</span> <span class="fa fa-angle-right" style="float: right; "></span></a>
									...
									<ul id="menu-academico-sub" >
									 ...
									 <li><a href="#"><i class="glyphicon glyphicon-question-sign"></i> <span>Help</span><span class="fa fa-angle-right" style="float: right"></span></a>
									   <ul>
										<li><a href="l"><i class="glyphicon glyphicon-earphone"></i> Call Us</a></li>
