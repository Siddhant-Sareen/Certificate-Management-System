...
<div style= "background:rgba(225,225,225,0.1);width:60%;"   class="container" id="con">
 <h1 style="color:#ffffff">Change Your Password</h1>
     <hr style="border-style:solid;width:100%;border-width:1px;border-color:grey"></hr>
	 <div class="row">
      <div class="col-sm-4 bg">
		<input type="hidden" id="username" value="<?php echo $_SESSION['fname']; ?>">
       <label for="name" style="color:#ffffff;" >Your Old Password</label>
       <input type="password" class="form-control a" id="old1"  name="name" >
	   </div>
	   <div class="col-sm-4 bg">
       <label for="name" style="color:#ffffff;" >Your New Password</label>
       <input type="password" class="form-control a" id="new1"  name="name"  onpaste="return false">
	   </div>
	   <div class="col-sm-4 bg">
      <label for="number" style="color:#ffffff;">Confirm Your Password</label>
      <input type="password" class="form-control a" id="confirm1"  name="confirm"  onpaste="return false">
	  </div>
	   
	   </div>
	   <br>
	   <div class="row">
	   <button type="button" class="btn btn-default" style="background-color:#88C9C9; margin-left:18px; " onclick="pass_change();">Change</button>
	   </div>
<br><br>
	   <div class="row">
...
<p style="color: #ffffff; font-size: 12px">(2017 All Rights Reserved)</p>
			...
			<!--/down-->
							<div class="down" style="text-transform:capitalize;">	
									 ...
									 <br>
									<ul>
									<li><a class="tooltips" ><span > <a type="button"  data-toggle="modal" data-target="#myModal"  style="background-color:rgba(255,255,255,0.1);text-decoration:none;"></span><i class="lnr lnr-user" style="cursor:pointer;border-style:none;border:0;"></i></a></li>
