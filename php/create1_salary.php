...
$sql= "insert into salary(name,f_name,email,number,job_title,date1,gross_salary,net_pay,reg_id,date_of_printing,certificate_category) values ('$a','$b','$c','$d','$e','$k','$k1','$l','$m','$o','$n')";
